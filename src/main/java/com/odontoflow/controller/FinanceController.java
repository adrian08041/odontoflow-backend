...
public class FinanceController {
    ...
    @Operation(summary = "Listar contas a receber", description = "Retorna paginado com filtros opcionais por busca textual (paciente ou descrição), status (Pendente, Pago, Atrasado), tipo (receita, despesa) e paciente")
    ...
    public ResponseEntity<PageResponse<FinanceReceivableResponse>> findAll(
        ...
        return ResponseEntity.ok(PageResponse.from(financeService.findAll(search, status, type, patientId, pageable)));
    }
