...
public class FinanceController {
    ...
    @Operation(summary = "Listar contas a receber", description = "Retorna paginado com filtro opcional por status (Pendente, Pago, Atrasado)")
    ...
    public ResponseEntity<Page<FinanceReceivableResponse>> findAll(
        ...
        return ResponseEntity.ok(financeService.findAll(status, pageable));
    }
